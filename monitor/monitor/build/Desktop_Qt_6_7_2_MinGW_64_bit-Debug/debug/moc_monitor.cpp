...
struct qt_meta_stringdata_CLASSmonitorENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmonitorENDCLASS = QtMocHelpers::stringData(
    "monitor",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmonitorENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject monitor::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSmonitorENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmonitorENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmonitorENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *monitor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmonitorENDCLASS.stringdata0))
